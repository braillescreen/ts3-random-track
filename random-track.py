...
minimumLines=input("Enter the minimum amount of lines you would like this track to have.")
maximumLines=input("Enter the maximum amount of lines you would like this track to have.")
